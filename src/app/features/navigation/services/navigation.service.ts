...
import {ForgotPasswordResponse, User, UserLimitCheck} from 'src/app/models/user.model';
...
export class NavigationService {
  ...
  changeUserRole(data) {
    return this.helperService.requestCall(this.helperService.constants.apiMethod.put,
      this.helperService.constants.apiRoutes.changeRoles, data);
  }
  ...
  getUserLimitExceededData(): Observable<UserLimitCheck> {
    return this.helperService.requestCall(this.helperService.constants.apiMethod.get,
      this.helperService.constants.apiRoutes.userLimitExceed);
  }
}
