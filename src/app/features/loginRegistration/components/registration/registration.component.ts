...
import {CountryCodes, RegistrationComp} from 'src/app/models/loginRegistration/registration.model';
import {BreakpointObserver, Breakpoints} from '@angular/cdk/layout';
import {map} from 'rxjs/operators';
import {countryCodeSource} from 'src/app/models/loginRegistration/countryCodes';
...
export class RegistrationComponent implements OnInit {
  ...
  countryCode: Array<CountryCodes> = null;
  selectedCode: string;
  codeList: Array<CountryCodes>;
  ...
  constructor(
    ...
    this.codeList = Object.assign([], this.countryCode);
    this.selectedCode = this.codeList[0].calling_code;
    this.initialize();
