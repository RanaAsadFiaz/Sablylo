...
export class CompilerProvider {
  ...
  constructUserData(profileApiResponse: any) {
    const user: UserData = profileApiResponse.data;
    return user;
  }
  ...
  constructProfileData(profileApiResponse: any) {
    const profileData: User = profileApiResponse;
    return profileData;
  }
  ...
  constructUserEntityData(loginApiResponse: any): EntityUserData {
    ...
    const userEntityData: EntityUserData = {
  ...
  constructOrganizationObject(organizationApiResponse: any): Organization {
    const organizationData: Organization = organizationApiResponse.data;
    ...
    this.navList = [
      ...
      },
      {
        ...
        children: [
          ...
          {
            displayName: 'Check-in by Activity',
