...
export class ConstantService {
  ...
  static apiRoutes = {
    ...
    getUserData: `${environment.apiUrl}/users/getUserData/`,
    ...
    unarchiveTeam: `${environment.apiUrl}/api/teams/unArchiveTeam/`,
    ...
    changeActiveEntity: `${environment.apiUrl}/entity/changeActiveEntity/`,
    ...
    actionsVsAlertsReport: `${environment.apiUrl}/api/analyticsReport/actionsVsAlertsReport/`,
    compliantReport: `${environment.apiUrl}/api/analyticsReport/compliantReport/`,
    ...
    archiveNotification: `${environment.apiUrl}/api/notification/archiveNotification/`,
    ...
    userLimitExceed: `${environment.apiUrl}/entity/userLimitExceed/`
  };
  /**
  ...
  static appConstant = {
    ...
    parent: 'parent',
    childYesToggle: 'childYesToggle',
    childNoToggle: 'childNoToggle',
    input: 'input',
    dateFrom: 'dateFrom',
    dateTo: 'dateTo',
    filter: 'filter',
